...
typedef struct
{
   char  *base;      // the fist address of the arena 
   char  *current;   // the pointer to the cuttent possion  and its type is float bc it points to float that is the data type of tensor's data 
